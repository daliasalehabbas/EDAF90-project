...
export class GraphViewerComponent implements OnInit {
  ...
  method(date:string, base:string, symbols:[]){
    var symbString = symbols.join(',');
    this.httpClient.get("http://api.exchangeratesapi.io/v1/"+date+"?access_key=7ec58f1adbc4b7c0654f3d03687420c6& base = "+base+"& symbols = "+symbString)
